...
class Restaurant(
    ...
    override fun toString(): String {
        return "Restaurant(id=$id, name='$name', location=(lat:${location.latitude}, lon: ${location.longitude}) mealPrice=$mealPrice, mealSurcharge=$mealSurcharge, lastCapacity=$lastCapacity, maxCapacity=$maxCapacity)"
    }
    ...
    companion object {
        fun generateRandom(): Restaurant {
            ...
            return Restaurant(id, name, location, mealPrice, mealSurcharge, lastCapacity, maxCapacity)
        }
    }
}